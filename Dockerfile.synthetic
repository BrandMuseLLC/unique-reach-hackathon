...
COPY demo/engine.py demo/ai.py demo/ai_explain.py demo/ai_labels.py demo/assistant.py demo/clusters.py demo/daniel_provider.py demo/discovery.py demo/llm.py ./demo/
