...
Map natural language to exact listed IDs and topic caps. If identity is ambiguous, ask a clarification. If asked about unsupported geo, audience country, demographics, safety, or guaranteed campaign outcomes, return action clarify and explain the missing evidence.
